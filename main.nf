...
def print_help() {
	...
	println "  --min_read_length						minimum read lenght cutoff after alignment (Current value: $(params.min_read_length))"
	println "  --max_read_length						maximum read length cutoff after alignment (Current value: $(params.max_read_length))"
	println "  --mapping_quality						minimum mapping quality cutoff after alignment (Current value: $(params.mapping_quality))"
	println "  --update_normalization_parallel			parallel computing value for update_normalization.nf module [single core] (Current value: $(params.update_normalization_parallel))"
	println "  --bedtools_slop <INT>					extending sequences value (bp) (Current value: $(params.bedtools_slop))"							
	println "  --extend_sequences_parallel				parallel computing value for extend_sequences.nf module [single core] (Current value: $(params.extend_sequences_parallel))"
	println "  --mapdamage_parallel						parallel computing value for mapDamage (Current value: $(params.mapdamage_parallel))"
	println "  --realign_parallel						parallel computing value for realign.nf module [multi core] (Current value: $(params.realign_parallel))"
	println "  --mafft_threads							thread usage for mafft (Current value: $(params.mafft_threads))"
	println "  --genotyper								genotyper software [bcftools,gatk] (Current value: $(params.genotyper))"
	println "  --bcftools_map_quality					minimum mapping quality after genotyping (Current value: $(params.bcftools_map_quality))"
	println "  --bcftools_base_quality					minimum base quality after genotyping (Current value: $(params.bcftools_base_quality))"
	println "  --variant_call_quality					minimum variant call quality for genotyping (Current value: $(params.variant_call_quality))"
