...
println "======================="
println "\n\033[1;31mBASIC OPTIONS\033[0m"
println "\n\033[1;37mData\033[0m: ${params.data}"
println "\n\033[1;37mOutput\033[0m: ${params.output}"
println "\n\033[1;37mGene completeness\033[0m: ${params.gene_completeness}"
println "\n\033[1;37mGenomes to download\033[0m: ${params.genomes}"
println "\n\033[1;37mConfig\033[0m: ${params.config}"
println "\n\033[1;37mParallel\033[0m: ${params.parallel}"
println "\n\033[1;37mTrusted data\033[0m: ${params.trusted_data}"
println "======================="
println "\n\033[1;31mProcess: get_data.nf\033[0m"
println "\n\033[1;37mParallel\033[0m: ${params.get_data_parallel}"
println "======================="
println "\n\033[1;31mProcess: remove_redundancy.nf\033[0m"
println "\n\033[1;37mParallel\033[0m: ${params.remove_redundancy_parallel}"
println "\n\033[1;37m[fastANI] threads\033[0m: ${params.fastANI_threads}"
println "======================="
println "\n\033[1;31mProcess: gene_clustering.nf\033[0m"
println "\n\033[1;37mGene identity threshold\033[0m: ${params.gene_identity_clustering}"
println "\n\033[1;37m[cd-hit] threads\033[0m: ${params.cd_hit_threads}"
println "======================="
println "\n\033[1;31mProcess: annotate.nf\033[0m"
println "\n\033[1;37m[prokka] Parallel\033[0m: ${params.prokka_annotate_parallel}"
println "\n\033[1;37m[prokka] Threads\033[0m: ${params.prokka_annotate_threads}"
println "======================="
...
println "======================="
println "\n\033[1;31mProcess: extend_sequences.nf\033[0m"
println "\n\033[1;37m[bedtools] Sequence extension\033[0m: ${params.bedtools_slop}"
println "\n\033[1;37mParallel\033[0m: ${params.extend_sequences_parallel}"
println "======================="
println "\n\033[1;31mProcess: outgroup_alignment.nf\033[0m"
println "\n\033[1;37m[bwa/samtools] Threads\033[0m: ${params.alignment_threads}"
println "\n\033[1;37m[bwa/samtools] Missing prob.\033[0m: ${params.missing_prob}"
println "\n\033[1;37m[bwa/samtools] Gap fraction\033[0m: ${params.gap_fraction}"
println "\n\033[1;37m[bwa/samtools] Seed\033[0m: ${params.seed}"
println "\n\033[1;37m[bwa/samtools] Min. read length\033[0m: ${params.min_read_length}"
println "\n\033[1;37m[bwa/samtools] Max. read length\033[0m: ${params.max_read_length}"
println "\n\033[1;37m[bwa/samtools] Mapping quality\033[0m: ${params.mapping_quality}"
println "\n\033[1;37m[bwa/samtools] Parallel\033[0m: ${params.alignment_parallel}"
println "======================="
println "\n\033[1;31mGenotyping\033[0m"
println "\n\033[1;37mGenotyper: \033[0m: ${params.genotyper}"
println "======================="
...
println "======================="
println "\n\033[1;31mProcess: realign.nf\033[0m"
println "\n\033[1;37mParallel \033[0m: ${params.realign_parallel}"
println "\n\033[1;37m[mafft] Threads\033[0m: ${params.mafft_threads}"
println "======================="
...
workflow {
	...
	FORMATTING_PANGENOME(EXTEND_SEQUENCES.out.extended_reference)
	...
	if (params.genotyper == "gatk") {
		...
		BCFTOOLS_CONSENSUS(FORMATTING_PANGENOME.out.map { pangenome_reference, pangenome_dict, pangenome_index -> pangenome_reference}, 
					ALIGNMENT_SUMMARY.out.postAlignmentFiles, params.alignment_parallel, tuple(params.bcftools_map_quality , params.bcftools_base_quality), params.bedtools_slop)
